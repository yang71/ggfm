...
from transformers import (get_linear_schedule_with_warmup, CLIPTextModel,
                          CLIPTokenizer, PreTrainedTokenizer, get_cosine_schedule_with_warmup,
                          AutoConfig, AutoModelForCausalLM,
                         LlamaConfig, LlamaModel, LlamaForCausalLM,
                         CLIPVisionModel, CLIPImageProcessor,BaseModelOutputWithPast, CausalLMOutputWithPast)
from transformers.configuration_utils import PretrainedConfig

from torch.optim import AdamW
import torch.nn as nn
import transformers
# from GraphGPT_basic_layers import MPNN, GNN, CLIP, graph_transformer
# import原来的graphgpt的几个基础conv，这里强行在下面开头把他们硬贴进来了
