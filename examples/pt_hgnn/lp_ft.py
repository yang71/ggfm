...
'''
    Dataset arguments
'''
parser.add_argument('--data_dir', type=str, default='/home/yjy/heteroPrompt/GPT-GNN/example_OAG/data/oag_output/graph_CS.pk',
                    help='The address of preprocessed graph.')
parser.add_argument('--use_pretrain', type=str, default=True, help='Whether to use pre-trained model')
parser.add_argument('--pretrain_model_dir', type=str, default='/home/yjy/heteroPrompt/GPT-GNN/example_OAG/models/gta_all_cs3',
...
# pairs: train_pairs[target_id] = [[source_id, ], _time]
